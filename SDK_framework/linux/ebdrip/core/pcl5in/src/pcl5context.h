...
extern struct PCL_RESOURCE_API_20140822 *pcl5permres_api;
void pcl5_id_cache_load_permanent_patterns(PCL5IdCache *udp_cache);
void pcl5_id_cache_load_permanent_macros(PCL5ResourceCaches *resource_caches);
void pcl5_id_cache_store_permanent_patterns(PCL5IdCache *udp_cache);
void pcl5_id_cache_store_permanent_macros(PCL5ResourceCaches *resource_caches);
...
void pcl5_string_id_cache_remove(PCL5StringIdCache *string_id_cache, pcl5_resource_string_id *string_id) ;
void pcl5_macro_string_id_cache_remove(PCL5ResourceCaches *resource_caches, pcl5_resource_string_id *string_id) ;
...
void pcl5_string_id_cache_remove_all(PCL5StringIdCache *string_id_cache, Bool include_permanent) ;
...
Bool pcl5_id_cache_insert_pattern(PCL5IdCache *id_cache, pcl5_resource_numeric_id id, pcl5_pattern *pattern, pcl5_pattern **new_pattern) ;
