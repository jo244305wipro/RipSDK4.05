...
dobuild() {
  ...
  # blits list
  blits="-va blits=1 -va blits=2 -va blits=4 -va blits=8 -va blits=hwa1 -va blits=backdrop"
  ...
  bt/hqmake $type $syst -va thirdparty -va customised=EBDEVAL -va security=le -va dll=nd -va rt_libs=multi_threaded $blits $vars $bldcopyto $tgts
